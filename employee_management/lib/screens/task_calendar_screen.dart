...
class _TaskCalendarScreenState extends State<TaskCalendarScreen> {
  ...
  void _loadTasks() {
    if (_selectedDay != null) {
      final tasks = context.read<EmployeeProvider>().getTasksForDate(_selectedDay!);
      setState(() {
        _tasks = tasks;
      });
    }
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                actions: [
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      context.read<EmployeeProvider>().deleteTask(task.id);
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text('Heure: ${DateFormat('HH:mm').format(task.date)}'),
                        ],
                      ),
                      trailing: Checkbox(
                        ...
                        onChanged: (bool? value) {
                          ...
                          context.read<EmployeeProvider>().updateTask(updatedTask);
                          _loadTasks();
                        },
                      ),
                    ),
